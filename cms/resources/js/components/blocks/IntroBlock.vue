      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16" ref="contentGridRef">
          ...
          <div :class="getContentOrderClasses()">
            ...
            <!-- CTA Button -->
            <div v-if="shouldShowCta" class="text-left">
              <div class="relative inline-block">
                ...
                <BaseButton 
                  ...
                  variant="primary" 
                  size="lg"
                  class="relative bg-black border-2 border-cyan-400 text-cyan-400 hover:text-black hover:bg-cyan-400 font-mono tracking-wider uppercase px-8 py-3 transition-all duration-300 group cyberpunk-btn-intro"
                >
...
const actualImageUrl = computed(() => {
  ...
  if (typeof props.image === 'string') {
    ...
    // Statamic assets are typically served from /assets/ not /storage/
    // Add /assets/ prefix if it doesn't already have it
    if (props.image.startsWith('assets/')) {
      return `/${props.image}`
    }
